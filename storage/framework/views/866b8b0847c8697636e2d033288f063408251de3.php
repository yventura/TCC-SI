                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $noturno; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e(date('d/m/Y', strtotime($note->data))); ?></td>
                                                <td><?php echo e($note->paralisacao_evento); ?></td>
                                                <td><?php echo e($note->atendimento_denuncia); ?></td>
                                                <td><?php echo e($note->atendimento_processos); ?></td>
                                                <td><?php echo e($note->comercio_ambulante); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
                                <?php echo e($noturno->links()); ?>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('noturno.createPDF')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                        <div class="row">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'noturnoIndex', 'titlePage' => __(' ')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto1\resources\views/noturno/index.blade.php ENDPATH**/ ?>