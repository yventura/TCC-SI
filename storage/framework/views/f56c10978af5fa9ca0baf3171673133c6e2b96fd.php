...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="container-fluid">
            <form method="post" action="<?php echo e(route('comercio_ambulante.store')); ?>" class="form-horizontal">
                <div class="row">
                    <div class="col-md-12">
                    <?php echo csrf_field(); ?>
                    <!-- Comercio Ambulante -->
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title"><?php echo e(__('Comercio Ambulante')); ?></h4>
                            </div>
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Orientação Retirada de cadeiras e Guarda-Sóis')); ?></label>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Orientação Retirada de Animais')); ?></label>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Orientação Retirada tendas, camping, churrasco')); ?></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Orientação Som abusivo')); ?></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Orientação Paralisação Esporte')); ?></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Orientação Ambulante Irregular - Praias e VC')); ?></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Vistorias/Cientificações/Apreensão - Praias')); ?></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Vistorias/Cientificações/Apreensão - VC')); ?></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label m-3"><?php echo e(__('Denuncias')); ?></label>
                                    <div class="col-sm-1">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'comercio_ambulante_Add', 'titlePage' => __(' ')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto1\resources\views/comercio_ambulante/create.blade.php ENDPATH**/ ?>
