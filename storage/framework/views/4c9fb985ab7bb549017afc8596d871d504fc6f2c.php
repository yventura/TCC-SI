...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="container-fluid">
            <form method="post" action="<?php echo e(route('feira_livre.store')); ?>" class="form-horizontal">
                <div class="row">
                    <div class="col-md-12">
                    <?php echo csrf_field(); ?>
                    <!-- Feira Livre -->
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title"><?php echo e(__('Feira Livre')); ?></h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <label style="color: black" class="col-sm-2 col-form-label"><?php echo e(__('Data')); ?></label>
                                    <div class="col-sm-2">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label"><?php echo e(__('Localização')); ?></label>
                                    <div class="col-sm-2">
                                ...
                                <div class="row">
                                    <label style="color: black" class="col-sm-4 col-form-label"><?php echo e(__('Informação')); ?></label>
                                    <div class="col-sm-4">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'livreAdd', 'titlePage' => __(' ')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto1\resources\views/feira_livre/create.blade.php ENDPATH**/ ?>
